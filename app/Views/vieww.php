...
<body class="index-page">
  ...
  <main class="main">
    ...
    <section id="hero" class="hero section dark-background">
      ...
      <img src="<?= base_url('assets/assets/vendors/images/Second trial.jpg')?>" alt=""> 
  ...
  <script src="<?=base_url('assets/assets/vendor/imagesloaded/imagesloaded.pkgd.min.js')?>"></script>
